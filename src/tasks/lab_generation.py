...
_TOOL_USAGE_MANDATE: str = (
    ...
    "}}\n"
    "```\n\n"
    "### 🔴 CRITICAL: File Paths MUST Use starter/ or solution/ Prefix\n\n"
    "Every key in the `files` dict MUST be prefixed with `starter/`, "
    "`solution/`, or `theory/`.  Files written directly at the tier root "
    "(e.g. just `etl.js` instead of `starter/etl.js`) will cause "
    "directory clutter and confusion.\n\n"
    "✅ CORRECT: `files = {{'starter/lab1.js': '...', 'solution/lab1.js': '...'}}`\n"
    "❌ WRONG:   `files = {{'lab1.js': '...'}}`  ← missing starter/ prefix\n\n"
