...
# ---------------------------------------------------------------------------
# GLR design directive — injected verbatim into the description.
# ---------------------------------------------------------------------------
_GLR_DESIGN_DIRECTIVE: str = (
    "## 🎨  GLR MEDIA CREATIVE — DOCUMENT BRANDING (NON-NEGOTIABLE)\n\n"
    "This syllabus is produced for **Grafisch Lyceum Rotterdam (GLR)** and "
    "MUST carry the GLR brand identity throughout.\n\n"
    "### Brand Identity\n"
    "- **Organisation:** Grafisch Lyceum Rotterdam (GLR)\n"
    "- **Design movement:** High-Contrast Brutalist Modernism\n"
    "- **Primary green:** `#76B800` / `#A6E22E` (electric lime)\n"
    "- **Primary black:** `#000000` (pure black)\n"
    "- **Accent blue:** `#002BFF` (ultramarine)\n\n"
    "### Document Style\n"
    "- Use **sharp, professional formatting** — clean headings, structured "
    "tables, clear visual hierarchy.\n"
    "- **Humanics tags** `[T]`, `[D]`, `[H]` should use inline HTML badge "
    "styling where the rendering platform supports it:\n"
    "  `<span style=\"display:inline-block;background:#000;color:#A6E22E;"
    "font-family:Space Grotesk,sans-serif;font-size:11px;font-weight:700;"
    "letter-spacing:0.1em;text-transform:uppercase;padding:2px 6px;\">[T]</span>`\n"
    "- **Tables:** Use structured Markdown tables. Include a GLR footer or "
    "metadata block at the end of every document:\n"
    "  ```\n"
    "  ---\n"
    "  *Generated by Syllabus Swarm for Grafisch Lyceum Rotterdam (GLR)*\n"
    "  ```\n"
    "- **Code blocks:** Always include language tags. Code should be clean, "
    "well-commented, and MBO4-appropriate.\n"
    "- **Callouts / important notes:** Use blockquotes (`>`) with bold labels "
    "for emphasis.\n"
    "- **Keep the document professional and clean** — avoid clip-art, emoji "
    "overuse, and decorative noise.\n"
)
# ---------------------------------------------------------------------------
...
def create_syllabus_generation_task(
    *,
    ...
    description = (
        ...
        .replace("_GLR_DESIGN_DIRECTIVE_", _GLR_DESIGN_DIRECTIVE)
    )
